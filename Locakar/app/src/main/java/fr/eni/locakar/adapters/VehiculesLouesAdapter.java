...
public class VehiculesLouesAdapter extends RecyclerView.Adapter<VehiculesLouesAdapter.ViewHolder> {
     ...
     */
    public VehiculesLouesAdapter(List<Vehicule> vehicules, View.OnClickListener monClickListener)
    {
     ...
     */
    @Override
    public VehiculesLouesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_cards_loues, parent, false);

        VehiculesLouesAdapter.ViewHolder vh = new VehiculesLouesAdapter.ViewHolder(v,monClickListener);
        return vh;
    }


    @Override
    public void onBindViewHolder(VehiculesLouesAdapter.ViewHolder holder, int position)
    {
